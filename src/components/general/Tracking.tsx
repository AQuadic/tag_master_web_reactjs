        ...
        <section className='mt-[57px]'>
            <div className='flex items-center gap-4'>
               <div className='w-full'>
                ...
                <p className='text-[#000000] md:text-xl text-xs mt-3 md:mx-8'>{t('step1')}</p>
               </div>
               <div className='w-full'>
                <div className='flex items-center gap-4'>
                     <div><BlueCircle /></div>
                ...
                <p className='text-[#000000] md:text-xl text-xs mt-3 md:mx-8'>{t('step2')}</p>
               </div>
                <div className='w-full'>
                <div className='flex items-center gap-4'>
                     <div><GrayCircle /></div>
                ...
                <p className='text-[#000000] md:text-xl text-xs mt-3 md:mx-8'>{t('step3')}</p>
               </div>
            </div>
        </section>
)
