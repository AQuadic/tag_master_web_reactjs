...
const MainCart = () => {
  ...
  const totalItemsPrice = data.items.reduce((sum: number, item: CartItem) => {
  ...
  return (
    <section className="container">
      ...
      <div className="mt-[50px] flex lg:flex-row flex-col items-start justify-between gap-4">
              ...
              <div className="xl:w-[535px] w-full lg:h-[184px] border border-[#D9D9D9] rounded-md py-4 px-8">
                <div className="flex items-center justify-between">
                  <h2 className="text-[#000000] text-[21px] font-bold">
                    {item.itemable.name?.[locale as "ar" | "en"]}
                  </h2>
                  <button
                ...
                <p className="text-[#464B4E] text-[17px] mt-2.5">
                  {item.itemable.description?.[locale as "ar" | "en"]}
                </p>
                <div className="flex items-center justify-between mt-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <p className="text-[#000000] text-[22px] min-w-[30px] text-center">
                      {item.quantity}
                    </p>
                    <button
        ...
        <div
          className="md:w-[400px] w-full h-full bg-[#FFFFFF] mt-4 rounded-[12px] py-[39px] px-[31px]"
            ...
            <Tabs defaultValue="total" dir="rtl">
              ...
              <TabsContent value="total">
                <div className="mt-[11px]">
                  <label htmlFor="code" className="text-[#000000] text-base">
                    {t("coupon")}
                  </label>
                  <div className="relative">
                    <div className="relative">
                      <input
                        type="text"
                        className="xl:md:w-[324px] w-full h-12 rounded-[8px] border border-[#000000] focus:outline-none mt-2 px-2"
                      />
                      <button className="w-[77px] h-[46px] bg-[#007EC1] rounded-[8px] text-[#FFFFFF] text-base font-medium absolute top-[9.4px] left-[1px]">
                        {t("apply")}
                      </button>
                    </div>
                  </div>
                ...
                <div className="mt-[28px]">
                  ...
                  {data.items.map((item: CartItem, index: number) => (
                    <div
                      key={index}
                      className="text-[#000000] text-base flex items-center justify-between mt-4"
                    >
                      <h3>
                        {item.itemable.name?.ar.length > 10
                          ? item.itemable.name?.[locale as "ar" | "en"].slice(
                              0,
                              20
                            ) + "..."
                          : item.itemable.name?.[locale as "ar" | "en"]}
                ...
                <div className="text-base font-bold flex items-center justify-between mt-4">
                  ...
                  <p className="text-[#15B600]">
                    {(
                      totalItemsPrice +
                      parseFloat(data.delivery_fees || 0) -
                ...
                <div className="flex items-center justify-center">
                  <button className="xl:w-[280px] w-full h-11 bg-[#007CC2] rounded-[8px] mt-4 text-[#FFFFFF] text-base">
                    {t("payNow")}
                  </button>
                </div>
              </TabsContent>
